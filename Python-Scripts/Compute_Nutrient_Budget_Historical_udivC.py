"""
This script can be used to area-integrated tracer budget terms (e.g. po4, no3) using cmip6 simulations. 
    ...
    for model in source_id:
        ...
        for dir1 in dir_list:
            ...
            for var in var_list:
                ...
                save_var_list = [var, var + '_u_div_x', var + '_u_div_y', var + '_u_div_z',
