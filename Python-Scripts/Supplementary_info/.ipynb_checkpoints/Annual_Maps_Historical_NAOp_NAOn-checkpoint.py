...
In this script, composites are created separately for NAO+ and NAO- phases.
"""
...
for dir1 in dir_list:
    ...
    for var1 in var_list:
        ...
        for cas in case:
            ...
            ds_ens_var = [] # dataset for annual maps
            ...
            # Save data
            ds_ens_var['lon'] = ds['lon']
            ds_ens_var['lat'] = ds['lat']
            ...
            save_file_path = (save_path + "/" + dir_name + "/Annual_Maps/" + var1 + "_" + cas + ".nc")
    
            ds_ens_var = ds_ens_var.astype(np.float32).compute()
            ds_ens_var.to_netcdf(save_file_path)
